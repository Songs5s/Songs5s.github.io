...
<title>工作室收徒官网_<?php echo $title ?></title>
    ...
    <div id="Main">
    	<div class="Main_Main">
        	...
        	<div class="Main_Input">
            	<div class="Input_top">
                    <a href="http://www.eb89.com/web.php?id=RIjZoBy" target="_blank">
                        <div class="Input_divimg" style="background:url(logo.png) no-repeat"><div class="yulan">预览</div></div>
                        <div class="Input_divspan"><span class="TemSpan">工作室收徒官网</span></div>
                    </a>
                </div>
                <div class="Input_bottom">
                    <form method="post" action="../result.php">
                    	<p><span><span class="redfh">* </span>请输入网页标题：</span><input class="input" type="text"  name="con1" placeholder="我的网页" /></p>
                        <p><span><span class="redfh">* </span>请输入工作室名称：</span><input class="input" type="text"  name="con2" placeholder="小彬网络科技" /></p>
                        <p><span class="redfh">* </span><span>加入我们跳转链接：</span><input class="input" type="text"  name="con3" placeholder="注意添加http://协议" /></p>
