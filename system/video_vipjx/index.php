...
<title>VIP视频解析系统_<?php echo $title ?></title>
    ...
    <div id="Main">
    	<div class="Main_Main">
        	...
        	<div class="Main_Input">
            	<div class="Input_top">
                    <a href="http://www.eb89.com/web.php?id=RIjZ4Zp" target="_blank">
                        <div class="Input_divimg" style="background:url(logo.png) no-repeat"><div class="yulan">预览</div></div>
                        <div class="Input_divspan"><span class="TemSpan">VIP视频解析系统</span></div>
                    </a>
                </div>
                <div class="Input_bottom">
                    <form method="post" action="../result.php">
                    	<p><span><span class="redfh">* </span>请输入网站标题：</span><input class="input" type="text"  name="con1" placeholder="我的系统" /></p>
                        <p><span><span class="redfh">* </span>请输入顶部标题：</span><input class="input" type="text"  name="con2" placeholder="VIP视频解析系统" /></p>
                        <p><span class="redfh">* </span><span>请输入网站公告：</span><textarea style="height:100px;" class="input" name="con3" placeholder="请输入公告">公告：接口更新，基本能免费解析全网VIP收费视频。</textarea></p>
                        <p><span><span class="redfh">* </span>请输客服ＱＱ号：</span><input class="input" type="text"  name="con4" placeholder="123456" maxlength="10" /></p>
                        ...
                        <p><span><span class="redfh">* </span>请输入底部版权：</span><input class="input" type="text"  name="con5" placeholder="底部版权" value="Copyright 2017 小彬" /></p>
