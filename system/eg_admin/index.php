...
<title>假后台恶搞页面_<?php echo $title ?></title>
    ...
    <div id="Main">
    	<div class="Main_Main">
        	...
        	<div class="Main_Input">
            	<div class="Input_top">
                    <a href="http://www.eb89.com/web.php?id=RIFIHhK" target="_blank">
                        <div class="Input_divimg" style="background:url(logo.png) no-repeat"><div class="yulan">预览</div></div>
                        <div class="Input_divspan"><span class="TemSpan">假后台恶搞页面</span></div>
                    </a>
                </div>
                <div class="Input_bottom">
                    <form method="post" action="../result.php">
                    	<p><span><span class="redfh">* </span>请输入后台标题：</span><input class="input" type="text"  name="con1" placeholder="我的后台" value="后台管理" /></p>
                        <p class="inputts">（说明：这是一个假后台恶搞的网站，预览的时候请注意别吓着了，有声音。电脑用户访问输入账号密码后是一个吓人的鬼脸带声音，手机用户访问输入账号密码后是叫chuang声音，老司机秒懂。）</p>
