...
<title>粉色飘叶个人主页_<?php echo $title ?></title>
    ...
    <div id="Main">
    	<div class="Main_Main">
        	...
        	<div class="Main_Input">
            	<div class="Input_top">
                    <a href="http://www.eb89.com/web.php?id=RMRsmpD" target="_blank">
                        <div class="Input_divimg" style="background:url(logo.png) no-repeat"><div class="yulan">预览</div></div>
                        <div class="Input_divspan"><span class="TemSpan">粉色飘叶个人主页</span></div>
                    </a>
                </div>
                <div class="Input_bottom">
                    <form method="post" action="../result.php">
                    	<p><span><span class="redfh">* </span>请输入网页标题：</span><input class="input" type="text"  name="con1" placeholder="我的主页" /></p>
                        <p><span><span class="redfh">* </span>头像图片地址：</span><input class="input" type="text"  name="con2" placeholder="头像图片地址" value="http://www.eb89.com/ph_fspyzy/tx.jpg" /></p>
                        ...
                        <p><span><span class="redfh">* </span>请输入主页签名一：</span><input class="input" type="text"  name="con4" placeholder="主页签名一 如：我们用心在做，EB89.Com -小彬" /></p>
                        <p><span><span class="redfh">* </span>请输入主页签名二：</span><input class="input" type="text"  name="con5" placeholder="主页签名二 如：做全网最专业的网页生成系统"  /></p>
                        ...
                        <p><span><span class="redfh">* </span>背景音乐地址：</span><input class="input" type="text"  name="con7" placeholder="背景音乐地址" value="http://p2.music.126.net/TkVXDADz7VjDHM4drkCuig==/5724057534301320.mp3" /></p>
