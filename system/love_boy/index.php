...
<title>动画表白网页_<?php echo $title ?></title>
    ...
    <div id="Main">
    	<div class="Main_Main">
        	...
        	<div class="Main_Input">
            	<div class="Input_top">
                    <a href="http://www.eb89.com/web.php?id=RIjZtNb" target="_blank">
                        <div class="Input_divimg" style="background:url(logo.png) no-repeat"><div class="yulan">预览</div></div>
                        <div class="Input_divspan"><span class="TemSpan">动画表白网页</span></div>
                    </a>
                </div>
                <div class="Input_bottom">
                    <form method="post" action="../result.php">
                    	<p><span><span class="redfh">* </span>请输入网页标题：</span><input class="input" type="text"  name="con1" placeholder="我的网页" /></p>
                        <p><span><span class="redfh">* </span>请输入网页内容：</span><input class="input" type="text"  name="con2" placeholder="老婆，爱你一生一世！" /></p>
