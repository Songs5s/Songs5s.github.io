...
<title>炫酷光线个人主页_<?php echo $title ?></title>
    ...
    <div id="Main">
    	<div class="Main_Main">
        	...
        	<div class="Main_Input">
            	<div class="Input_top">
                    <a href="http://www.eb89.com/web.php?id=RM0yHfd" target="_blank">
                        <div class="Input_divimg" style="background:url(logo.png) no-repeat"><div class="yulan">预览</div></div>
                        <div class="Input_divspan"><span class="TemSpan">炫酷光线个人主页</span></div>
                    </a>
                </div>
                <div class="Input_bottom">
                    <form method="post" action="../result.php">
                    	<p><span><span class="redfh">* </span>请输入网站标题：</span><input class="input" type="text"  name="con1" placeholder="我的主页" /></p>
                        <p><span><span class="redfh">* </span>头像图片地址：</span><input class="input" type="text"  name="con2" placeholder="头像图片地址" value="http://www.eb89.com/ph_xkgxzy/tx.png" /></p>
                        ...
                        <p><span><span class="redfh">* </span>请输入底部版权：</span><input class="input" type="text"  name="con8" placeholder="底部版权" value="Copyright 2017 小彬" /></p>
                        <p><span><span class="redfh">* </span>背景音乐地址：</span><input class="input" type="text"  name="con9" placeholder="背景音乐地址" value="http://p2.music.126.net/pOH2QXwQc_7IX4l2sB-iSA==/7954966629620463.mp3" /></p>
