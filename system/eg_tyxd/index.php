...
<title>体验吸毒页面_<?php echo $title ?></title>
    ...
    <div id="Main">
    	<div class="Main_Main">
        	...
        	<div class="Main_Input">
            	<div class="Input_top">
                    <a href="http://www.eb89.com/web.php?id=RM8QtEI" target="_blank">
                        <div class="Input_divimg" style="background:url(logo.png) no-repeat"><div class="yulan">预览</div></div>
                        <div class="Input_divspan"><span class="TemSpan">体验吸毒页面</span></div>
                    </a>
                </div>
                <div class="Input_bottom">
                    <form method="post" action="../result.php">
                    	<p><span><span class="redfh">* </span>请输入网页标题：</span><input class="input" type="text"  name="con1" placeholder="戒毒中心" /></p>
                        <p><span><span class="redfh">* </span>请输入网页内容一：</span><input class="input" type="text"  name="con2" placeholder="网页内容一" value="你即将出现幻觉。" /></p>
                        <p><span><span class="redfh">* </span>请输入网页内容二：</span><input class="input" type="text"  name="con3" placeholder="网页内容二" value="你周围的世界会改变形状，显得扭曲和变形。" /></p>
                        <p><span><span class="redfh">* </span>请输您的ＱＱ号：</span><input class="input" type="text"  name="con4" placeholder="123456" maxlength="10" /></p>
