...
<title>魔幻粒子表白网页_<?php echo $title ?></title>
    ...
    <div id="Main">
    	<div class="Main_Main">
        	...
        	<div class="Main_Input">
            	<div class="Input_top">
                    <a href="http://www.eb89.com/web.php?id=RM0brE7" target="_blank">
                        <div class="Input_divimg" style="background:url(logo.png) no-repeat"><div class="yulan">预览</div></div>
                        <div class="Input_divspan"><span class="TemSpan">魔幻粒子表白网页</span></div>
                    </a>
                </div>
                <div class="Input_bottom">
                    <form method="post" action="../result.php">
                    	<p><span><span class="redfh">* </span>请输入网页标题：</span><input class="input" type="text"  name="con1" placeholder="我的网页" /></p>
                        <p><span><span class="redfh">* </span>请输入网页内容：</span><input class="input" type="text"  name="con2" placeholder="内容请使用： | 隔开" value="亲爱的|老婆大人|你即将成为|全世界|最幸福|的妻子。" /></p>
                        <p><span><span class="redfh">* </span>请输入跳转链接：</span><input class="input" type="text"  name="con3" placeholder="跳转地址" value="http://www.eb89.com/love_mhlz/" /></p>
                        <p class="inputts">（说明：网页每页内容请使用：“|” 符号隔开 ”）</p>
